...
import com.tianbao54.activemq.producer.messaging.MessageReceiver;

@Configuration
public class MessagingConfiguration {

	private static final String DEFAULT_BROKER_URL = "tcp://yuppy01:61616";
	...
	public ConnectionFactory connectionFactory(){
		...
		connectionFactory.setTrustedPackages(Arrays.asList("com.tianbao54.activemq"));
